    ...
    >
      <div className="mx-auto w-full max-w-[1080px] px-6 lg:px-8 flex items-center justify-between h-[58px]">
        <Link href="/" className="flex items-center gap-2">
          <DocxLogo />
          <span className="font-semibold text-[19px] tracking-[-0.02em]" style={{ color: "var(--lp-ink)" }}>
            DocX
          </span>
        </Link>

        <nav className="hidden md:flex items-center gap-6 text-[13.5px]" style={{ color: "var(--lp-muted)" }}>
          <Link href="#features" className="hover:text-[var(--lp-ink)] transition-colors">Features</Link>
          <Link href="#how" className="hover:text-[var(--lp-ink)] transition-colors">How it works</Link>
          <Link href="/document" className="hover:text-[var(--lp-ink)] transition-colors">Editor</Link>
