...
export default function HeroImage() {
  ...
  return (
    <div ref={containerRef} className="grid pt-20 place-items-center">
      ...
      >
        Seamless <span className="text-blue-500">Collaboration </span>with
      ...
      >
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(50% 3972% at 50% 50%, rgba(9, 170, 255, 0.9) 0%, rgba(255, 255, 255, 0) 100%)",
          }}
        ...
        <motion.div
          ...
          style={{
            opacity: opacityProgress,
            background:
              "radial-gradient(50% 50% at 50% 50%, rgb(0 102 255) 50%, rgba(171, 171, 171, 0) 100%)",
          }}
        ></motion.div>
        <motion.div
          ...
          style={{
            opacity: opacityProgress,
            background:
              "radial-gradient(50% 50% at 50% 50%, rgba(0, 102, 255, 0.3) 0%, rgba(171, 171, 171, 0) 100%)",
          }}
        ></motion.div>
        <motion.div
